...
train_2 = np.full((len(user_artist_data_zeros),
                   len(user_artist_data_zeros[0, :])), 0.0)
...
encoded = Dense(encoding_dim, activation='sigmoid',
                activity_regularizer=regularizers.l2(1e-3))(concatLayer)
decoded = Dense(output_dim, activation='linear',
